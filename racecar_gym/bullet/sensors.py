...
class AccelerationSensor(BulletSensor):
    @dataclass
    class Config:
        time_delta: float
...
class VelocitySensor(BulletSensor):
    @dataclass
    class Config:
        gaussian_noise: float
